  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="list" border stripe  max-height="470">
        ...
        <el-table-column prop="fireProtectionTeamID" label="防火队伍ID" sortable></el-table-column>
        <el-table-column prop="fireProtectionTeamMember" label="人员姓名" sortable></el-table-column>
        <el-table-column prop="fireProtectionTeamContact" label="联系方式" sortable></el-table-column>
