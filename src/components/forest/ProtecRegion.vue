  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="list" border stripe  max-height="470">
        ...
        <el-table-column prop="MainPreservingZoneID" label="大区域ID" sortable></el-table-column>
        <el-table-column prop="MainPreservingZoneName" label="大区域名称" sortable></el-table-column>
        <el-table-column prop="MainPreservingZoneAcreage" label="大区域面积" sortable></el-table-column>
        <el-table-column prop="SubPreservingZoneID" label="子区域ID" sortable></el-table-column>
        <el-table-column prop="SubPreservingZoneName" label="子区域名称" sortable></el-table-column>
        <el-table-column prop="experiment" label="子区域范围">
          <template slot-scope="scope">
            <el-popover placement="bottom" width="200" trigger="click" v-bind:content="scope.row.SubPreservingZoneCoordinates">
              <el-button type="primary" size="mini" slot="reference">查看</el-button>
            </el-popover>
          </template>
        </el-table-column>
        <el-table-column prop="SubPreservingZoneAcreage" label="监控区域名称" sortable></el-table-column>
        <el-table-column prop="SubPreservingZoneBelongtoDistId" label="监控区域名称" sortable></el-table-column>
