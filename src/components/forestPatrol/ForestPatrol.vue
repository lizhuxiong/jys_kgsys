<template>
	<div>
        ...
        border：边框-->
				...
				<el-table-column prop="fireProtectionTeamID" label="巡检员ID" sortable></el-table-column>
				<el-table-column prop="fireProtectionTeamMember" label="巡检员姓名"></el-table-column>
